...
public class ObjectFactory {
    ...
    private BenchmarkConfigurator benchmarkConfigurator = new BenchmarkConfiguratorImpl();
    ...
    public <T> T createObject(Class<T> type) {
        ...
        t = benchmarkConfigurator.handleBenchmark(type, t);
...
//    private <T> T handleBenchmark(Class<T> type, T t){
//        T result = t;
//        if (type.isAnnotationPresent(Benchmark.class)) {
//            result = (T) Proxy.newProxyInstance(type.getClassLoader(), type.getInterfaces(), new InvocationHandler() {
//                @Override
//                public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
//                    System.out.println("********* BENCHMARK started for method "+method.getName()+" ***********");
//                    long start = System.nanoTime();
